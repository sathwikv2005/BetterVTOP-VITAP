...
export default function VersionInfo() {
	...
	const styles = StyleSheet.create({
		...
		box: { flexDirection: 'column', width: '100%', padding: 10, paddingHorizontal: 20 },
		headingBox: { flexDirection: 'row', gap: 7 },
		versionBox: { gap: 0 },
		githubBox: { flexDirection: 'row', gap: 5, alignItems: 'center' },
		sub: { marginTop: 4 },
		icon: { marginTop: 6 },
		border: {
			width: '100%',
